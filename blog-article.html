	...
	<body id="blog-article">
		...
		<div class="wrapper">
			...
			<div class="grid-container">
				<div class="grid-x grid-margin-x">
					...
					<article class="cell medium-8">
						<section class="blog-article">
							<h1>How to Become an Airline Pilot</h1>
				...
				<!--blog grid-->
				<section class="grid-x grid-margin-x box-grid up-2">
					<h1 class="cell">See Also</h1>
					<!--two cell blog grid-->
					<article class="cell medium-6">
						<h1>Destinations</h1>
						<p>Los Angeles Resturant Reccomendations</p>
					</article>
					<article class="cell medium-6">
						<h1>Life</h1>
						<p>Common Pilot Errors and How To Avoid Them</p>
					</article>
				</section>	
				<section class="grid-x grid-margin-x box-grid up-4">
					<!---four cell blog grid-->
