                            ...
                            <section class="grid-x grid-margin-x">
                              ...
                              <div class="cell medium-3">
                                <ul class="vertical tabs" data-tabs id="example-tabs">
                                  <li class="tabs-title is-active"><a href="#panel1v" aria-selected="true">Class 1</a></li>
                                  <li class="tabs-title"><a href="#panel2v">Class 2</a></li>
                                  <li class="tabs-title"><a href="#panel3v">Class 3</a></li>
                                  <li class="tabs-title"><a href="#panel4v">Class 4</a></li>
                                  <li class="tabs-title"><a href="#panel5v">Class 5</a></li>
                                  <li class="tabs-title"><a href="#panel6v">Class 6</a></li>
                                </ul>
                              </div>
                              <div class="cell medium-9">
                                <div class="tabs-content" data-tabs-content="example-tabs">
                                  <div class="tabs-panel  animated fadeIn is-active" id="panel1v">
                                    <p>One</p>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit praesentium nostrum, necessitatibus voluptas saepe rem expedita aspernatur exercitationem ab repellendus culpa illum officia. Quo nemo eaque culpa est temporibus aut.</p>
                                  </div>
                                  <div class="tabs-panel animated fadeIn " id="panel2v">
                                    <p>Two</p>
                                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit explicabo amet, distinctio repellendus modi aperiam aut nesciunt quo. Consequatur culpa ipsam rem placeat molestias vero possimus? Voluptatum optio reprehenderit molestiae!</p>
                                  </div>
                                  <div class="tabs-panel animated fadeIn " id="panel3v">
                                    <p>Three</p>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit praesentium nostrum, necessitatibus voluptas saepe rem expedita aspernatur exercitationem ab repellendus culpa illum officia. Quo nemo eaque culpa est temporibus aut.</p>
                                  </div>
                                  <div class="tabs-panel animated fadeIn " id="panel4v">
                                    <p>Four</p>
                                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit explicabo amet, distinctio repellendus modi aperiam aut nesciunt quo. Consequatur culpa ipsam rem placeat molestias vero possimus? Voluptatum optio reprehenderit molestiae!</p>
                                  </div>
                                  <div class="tabs-panel animated fadeIn " id="panel5v">
                                    <p>Five</p>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit praesentium nostrum, necessitatibus voluptas saepe rem expedita aspernatur exercitationem ab repellendus culpa illum officia. Quo nemo eaque culpa est temporibus aut.</p>
                                  </div>
                                  <div class="tabs-panel animated fadeIn " id="panel6v">
                                    <p>Six</p>
                                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit explicabo amet, distinctio repellendus modi aperiam aut nesciunt quo. Consequatur culpa ipsam rem placeat molestias vero possimus? Voluptatum optio reprehenderit molestiae!</p>
                                  </div>
                                </div>
